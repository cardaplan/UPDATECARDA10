...
/**
 * ID da planilha principal (SHEET_ID) para endpoints rápidos (export/gviz).
 * Ex.: '1AbCDefGhijkLmNoPqRsTuVwXyZ1234567890'
 * Quando preenchido, o sistema buscará os dados pelos endpoints export/gviz
 * evitando o atraso de "Publicar na Web".
 */
const SHEET_ID = '1QfyYvRFvC3bRUYaENOdEH6Y2m-aTIOHDOYVY6f4jccI';
